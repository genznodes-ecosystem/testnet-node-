...
```
tx = sfcc.createValidator("VALIDATOR_PUBKEY", {from:"WALLET_ADDRESS", value: web3.toWei("200000.0", "vc")})
```
...
Check your validator ID by wallet_address 

```bash
sfcc.getValidatorID("WALLET_ADDRESS")
```
...
and then  `CTRL + C` > `CTRL + D` . please killed your screen 
